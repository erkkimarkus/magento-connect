 ...
 * production code paths). create() throws — tests that reach it are
 * misconfigured; the paths under test here never do.
 */
if (!class_exists(CollectionFactory::class, false)) {
    class CollectionFactory
    {
        ...
        {
            throw new \RuntimeException('CustomerCollectionFactory is not available in integration tests');
        }
    }
}
