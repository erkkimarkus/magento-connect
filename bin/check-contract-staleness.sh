...
# (PRO-1252; Decision A on PRO-1247: vendored byte-identical copies stay, but
...
echo "Sync the vendored copy byte-identically from the engine repo, and carry any" >&2
echo "contract changes through to code and test fixtures in the same pass." >&2
exit 1
